...
export default function UploadPage() {
  ...
  const { currentUser, isLoaded, createRecipe } = useRecipeStore()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newRecipe = createRecipe({
      ...
      image: formData.image || "/placeholder.svg?key=uploadPlaceholder",
    })
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Upload your favorite recipe to the community</p>
        </div>
